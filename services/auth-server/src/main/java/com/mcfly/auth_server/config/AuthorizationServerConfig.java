package com.mcfly.auth_server.config;

import com.mcfly.auth_server.authentication.DeviceClientAuthenticationProvider;
import com.mcfly.auth_server.federation.FederatedIdentityIdTokenCustomizer;
import com.mcfly.auth_server.jose.Jwks;
import com.mcfly.auth_server.web.authentication.DeviceClientAuthenticationConverter;
...
public class AuthorizationServerConfig {
	...
	public RegisteredClientRepository registeredClientRepository(JdbcTemplate jdbcTemplate) {
		RegisteredClient registeredClient = RegisteredClient.withId(UUID.randomUUID().toString())
				...
				.redirectUri("http://auth-client:8080/login/oauth2/code/messaging-client-oidc")
				.redirectUri("http://auth-client:8080/authorized")
				.postLogoutRedirectUri("http://auth-client:8080/logged-out")
